...
describe("OptimizeRequestDto", () => {
  ...
  it("fails validation when duration_sec exceeds the upper bound", async () => {
    const dto = plainToInstance(OptimizeRequestDto, {
      scenario: {
        seed: 1,
        duration_sec: 999999,
  ...
  it("fails validation when candidates exceeds the upper bound", async () => {
    const dto = plainToInstance(OptimizeRequestDto, {
      scenario: {
        seed: 1,
        duration_sec: 300,
